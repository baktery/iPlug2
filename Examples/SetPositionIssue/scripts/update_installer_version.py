...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SetPositionIssue Demo Installer\n"
      else:
        line="OutputBaseFilename=SetPositionIssue Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SetPositionIssue Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SetPositionIssue installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SetPositionIssue Demo installer\n"
     else:
       line="SetupWindowTitle=SetPositionIssue installer\n"
