...
def main():
  ...
  plistpath = scriptpath + "/resources/SetPositionIssue-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SetPositionIssue-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SetPositionIssue-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SetPositionIssue-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SetPositionIssue-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SetPositionIssue.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SetPositionIssue.iss",inplace=1):
